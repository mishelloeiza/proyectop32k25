...
public class MantenimientoJornadas extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeCombos() {
        ...
        for (int i = 0; i < jornadas.size(); i++) {
            cbox_empleado.addItem(jornadas.get(i).getNombre_jornada());
        }
    }
    ...
    public void buscarVendedor() {
        Jornadas jornadasAConsultar = new Jornadas();
        JornadasDAO jornadasDAO = new JornadasDAO();
        jornadasAConsultar.setCodigo_jornada(Integer.parseInt(txtbuscado.getText()));
        jornadasAConsultar= jornadasDAO.query(jornadasAConsultar);
        txtNombre.setText(jornadasAConsultar.getNombre_jornada());
        txtEstatus.setText(jornadasAConsultar.getEstatus_jornada());
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        JornadasDAO jornadasDAO = new JornadasDAO();
        Jornadas jornadasAEliminar = new Jornadas();
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        JornadasDAO jornadasDAO = new JornadasDAO();
        Jornadas jornadasAInsertar = new Jornadas();
        jornadasAInsertar.setNombre_jornada(txtNombre.getText());
...
//        // TODO add your handling code here:
        JornadasDAO jornadasDAO = new JornadasDAO();
        Jornadas jornadasAActualizar = new Jornadas();
        jornadasAActualizar.setCodigo_jornada(Integer.parseInt(txtbuscado.getText()));
        jornadasAActualizar.setNombre_jornada(txtNombre.getText());

...
public class MantenimientoAulas extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        modelo.addColumn("Codigo Aula");
        modelo.addColumn("Nombre Aula");
        modelo.addColumn("Estatus Aula");
        AulasDAO aulasDAO = new AulasDAO();
        List<Aulas> aulas = aulasDAO.select();
        tablaAulas.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < aulas.size(); i++) {
            dato[0] = Integer.toString(aulas.get(i).getCodigoAula());
            dato[1] = aulas.get(i).getNombreAula();
            dato[2] = aulas.get(i).getEstatusAula();
    ...
    public void buscarVendedor() {
        Aulas aulaAConsultar = new Aulas();
        AulasDAO aulasDAO = new AulasDAO();
        aulaAConsultar.setCodigoAula(Integer.parseInt(txtbuscado.getText()));
        aulaAConsultar = aulasDAO.query(aulaAConsultar);
        txtNombre.setText(aulaAConsultar.getNombreAula());
        txtEstatus.setText(aulaAConsultar.getEstatusAula());
    }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        AulasDAO aulasDAO = new AulasDAO();
        Aulas aulaAEliminar = new Aulas();
        aulaAEliminar.setCodigoAula(Integer.parseInt(txtbuscado.getText()));
        aulasDAO.delete(aulaAEliminar);
        llenadoDeTablas();
    }//GEN-LAST:event_btnEliminarActionPerformed

    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        AulasDAO aulasDAO = new AulasDAO();
        Aulas aulaAInsertar = new Aulas();
        aulaAInsertar.setNombreAula(txtNombre.getText());
        aulaAInsertar.setEstatusAula(txtEstatus.getText());
        aulasDAO.insert(aulaAInsertar);
        llenadoDeTablas();
...
//        // TODO add your handling code here:
        AulasDAO aulasDAO = new AulasDAO();
        Aulas aulaAActualizar = new Aulas();
        ...
        aulasDAO.update(aulaAActualizar);
        llenadoDeTablas();

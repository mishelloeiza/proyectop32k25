...
public class MantenimientoCarrera extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        List<Carrera> carrera = carreraDAO.select();
        
        tablaCarrera.setModel(modelo);
        String[] dato = new String[4];
        for (int i = 0; i < carrera.size(); i++) {
            dato[0] = Integer.toString(carrera.get(i).getCodigo_carrera());
            dato[1] = carrera.get(i).getNombre_carrera();
            dato[2] = Integer.toString(carrera.get(i).getCodigo_facultad());
            dato[3] = carrera.get(i).getEstatus_carrera();
    ...
    public void buscarCarrera() {
        ...
        // Convert the int to String before setting it in txtFacultad
        int codigoFacultad = carreraAconsultar.getCodigo_facultad();
    ...
    private void initComponents() {
        ...
        tablaCarrera.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        ...
        lbltel.setText("Codigo Facultad");
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addComponent(txtFacultad, javax.swing.GroupLayout.PREFERRED_SIZE, 263, javax.swing.GroupLayout.PREFERRED_SIZE))
                                    .addGroup(layout.createSequentialGroup()
        ...
        getAccessibleContext().setAccessibleName("Mantenimiento Carrera");

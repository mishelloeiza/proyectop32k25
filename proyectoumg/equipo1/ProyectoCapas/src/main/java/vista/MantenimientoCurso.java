...
public class MantenimientoCurso extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
       ...
       tablacurso.setModel(modelo);
        ...
        for (Curso curso : cursos) {
            dato[0] = Integer.toString(curso.getCodigo_curso());
            dato[1] = curso.getNombre_curso();
            dato[2] = curso.getEstatus_curso();
            modelo.addRow(dato);
        }
    }
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
       ...
       cursoDAO.insert(cursoAInsertar);
        llenadoDeTablas();
         String mensaje = "Curso Registrado: " + txtNombre.getText();
    domain.Bitacora.registrarEvento(mensaje);
...
//      VendedorDAO vendedorDAO = new VendedorDAO();
        ...
        llenadoDeTablas();
         String mensaje = "Curso Modificado: " + txtNombre.getText() + " | Codigo: " + txtbuscado.getText();
    domain.Bitacora.registrarEvento(mensaje);

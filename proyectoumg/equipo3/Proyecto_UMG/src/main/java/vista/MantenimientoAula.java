...
public class MantenimientoAula extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeCombos() {
        ...
        List<Aula> salon = aulaDAO.select();
        cbox_empleado.addItem("Seleccione una opción");
        for (int i = 0; i < salon.size(); i++) {
            cbox_empleado.addItem(salon.get(i).getNombreAula());
        }
    }
    ...
    public void llenadoDeTablas() {
        ...
        modelo.addColumn("NombreAula");
        modelo.addColumn("EstatusAula");
        AulasDAO aulaDAO = new AulasDAO();
        List<Aula> aulas = aulaDAO.select();
        tablaAula.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < aulas.size(); i++) {
            dato[0] = Integer.toString(aulas.get(i).getCodigoAulas());
    ...
    public void buscarVendedor() {
        Aula aulaAConsultar = new Aula();
        AulasDAO aulaDAO = new AulasDAO();
        aulaAConsultar.setCodigoAulas(Integer.parseInt(txtbuscado.getText()));
        aulaAConsultar = aulaDAO.query(aulaAConsultar);
...
//        // TODO add your handling code here:
        ...
        aulaAActualizar.setCodigoAulas(Integer.parseInt(txtbuscado.getText()));

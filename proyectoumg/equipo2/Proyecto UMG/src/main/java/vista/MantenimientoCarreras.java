...
public class MantenimientoCarreras extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeCombos() {
        ...
        for (int i = 0; i < carreras.size(); i++) {
            cbox_empleado.addItem(carreras.get(i).getNombre_carrera());
        }
    }
    ...
    public void llenadoDeTablas() {
        ...
        for (int i = 0; i < carreras.size(); i++) {
            dato[0] = Integer.toString(carreras.get(i).getCodigo_carrera());
            dato[1] = carreras.get(i).getNombre_carrera();
            dato[2] = Integer.toString(carreras.get(i).getCodigo_facultad());
    ...
    public void buscarCarrera() {
        ...
        CarrerasDAO carreraDAO = new CarrerasDAO();
        carreraAConsultar.setCodigo_carrera(Integer.parseInt(txtbuscado.getText()));
        carreraAConsultar = carreraDAO.query(carreraAConsultar);
        txtNombre.setText(carreraAConsultar.getNombre_carrera());
        txtCodigoFacultad.setText(String.valueOf(carreraAConsultar.getCodigo_facultad()));
    ...
    private void initComponents() {
        ...
        tablaCarreras.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Alumno", "ID Empleado", "Correo", "Telefono", "Direccion", "Porcentaje", "Comision"
            }
        ));
        ...
        txtCodigoFacultad.setOpaque(false);
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addComponent(txtCodigoFacultad, javax.swing.GroupLayout.PREFERRED_SIZE, 263, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    CarrerasDAO alumnoDAO = new CarrerasDAO();
    Carreras carreraAInsertar = new Carreras(); 
        carreraAInsertar.setNombre_carrera(txtNombre.getText());
        carreraAInsertar.setCodigo_facultad(Integer.parseInt(txtCodigoFacultad.getText()));
        carreraAInsertar.setEstatus_carrera(txtEstatus.getText());
        alumnoDAO.insert(carreraAInsertar);
        llenadoDeTablas();
...
//        // TODO add your handling code here:
        ...
        carreraAActualizar.setCodigo_facultad(Integer.parseInt(txtCodigoFacultad.getText()));

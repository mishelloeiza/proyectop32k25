...
public class SedeDAO {
    ...
    public List<Sede> select() { //primer mantenimiento, va a consultar
    ...
    public int insert(Sede sede) { //segundo metodo, permite establecer informacion
        Connection conn = null;
        PreparedStatement stmt = null;
        int rows = 0;
        try {
    ...
    public int update(Sede sede) { //tercer mantenimiento, actualiza
        Connection conn = null;
        PreparedStatement stmt = null;
        int rows = 0;
    ...
    public int delete(Sede sede) {//cuarto metodo, borra
        Connection conn = null;
        PreparedStatement stmt = null;
        int rows = 0;

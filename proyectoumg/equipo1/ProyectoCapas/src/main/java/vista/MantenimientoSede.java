...
public class MantenimientoSede extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
        ...
        List<Sede> sedes = sedeDAO.select();

       tablaSe.setModel(modelo);
        String[] dato = new String[3];

        for (Sede sede : sedes) {
            dato[0] = Integer.toString(sede.getCodigo_sede());
            dato[1] = sede.getNombre_sede();
            dato[2] = sede.getEstatus_sede();
            modelo.addRow(dato);
        }
    }
    ...
    private void initComponents() {
        ...
        tablaSe.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
        ...
        jScrollPane1.setViewportView(tablaSe);
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
     SedeDAO sedeDAO = new SedeDAO();
       ...
       sedeAInsertar.setEstatus_sede(txtEstatus.getText());
        ...
        llenadoDeTablas();
         String mensaje = "Sedeliminada¡: Código Sede " + txtbuscado.getText();
domain.Bitacora.registrarEvento(mensaje);
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
       ...
       sedeDAO.insert(sedeAInsertar);
        llenadoDeTablas();
               String mensaje = "Sede Registrada¡: Código Sede " + txtbuscado.getText();
domain.Bitacora.registrarEvento(mensaje);
...
//      VendedorDAO vendedorDAO = new VendedorDAO();
        ...
        llenadoDeTablas();
        String mensaje = "Sede Modificada¡: Código Sede " + txtbuscado.getText();
domain.Bitacora.registrarEvento(mensaje);

...
public class CarreraDAO {
    ...
    public List<Carrera> select() {
        ...
        ResultSet rs = null;
        Carrera carrera = null;//alumno es un objeto
        List<Carrera> carreras = new ArrayList<Carrera>();//alumnos sera la lista donde se guardaran 

        try {//try y catch sirve para capturar el error y permitir que siga avanzando
    ...
    public Carrera query(Carrera carrera) {    
        ...
        try {
            ...
            while (rs.next()) {
                int codigoCarrera = rs.getInt("codigo_carrera");
                String nombreCarrera = rs.getString("nombre_carrera");
                int codigoFacultad = rs.getInt("codigo_carrera");
                String estatusCarrera = rs.getString("estatus_carrera");

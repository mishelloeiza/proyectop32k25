...
public class MantenimientoSeccion extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeTablas() {
       ...
       tablaSeccion.setModel(modelo);
        String[] dato = new String[3];

        for (Seccion seccion : secciones) {
            dato[0] = Integer.toString(seccion.getCodigo_seccion());
            dato[1] = seccion.getNombre_seccion();
            dato[2] = seccion.getEstatus_seccion();
            modelo.addRow(dato);
        }
    }
    ...
    private void initComponents() {
        ...
        tablaSeccion.setFont(new java.awt.Font("Century Gothic", 0, 12)); // NOI18N
...
//      VendedorDAO vendedorDAO = new VendedorDAO();
        ...
        seccionAActualizar.setCodigo_seccion(Integer.parseInt(txtbuscado.getText()));

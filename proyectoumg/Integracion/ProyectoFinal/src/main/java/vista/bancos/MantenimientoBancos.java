...
public class MantenimientoSedes extends javax.swing.JInternalFrame {
    ...
    public void llenadoDeCombos() {
        ...
        for (int i = 0; i < sedes.size(); i++) {
            cbox_empleado.addItem(sedes.get(i).getNombre_sede());
        }
    }
    ...
    public void llenadoDeTablas() {
        ...
        SedeDAO sedeDAO = new SedeDAO();
        List<Sede> sede = sedeDAO.select();
        tablaVendedores.setModel(modelo);
        String[] dato = new String[3];
        for (int i = 0; i < sede.size(); i++) {
            dato[0] = Integer.toString(sede.get(i).getCodigo_sede());
            dato[1] = sede.get(i).getNombre_sede();
            dato[2] = sede.get(i).getEstatus_sede();
